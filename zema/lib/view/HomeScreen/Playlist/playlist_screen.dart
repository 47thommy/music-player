...
import 'package:zema/view/HomeScreen/Playlist/playlist_single.dart';
...
class _PlaylistScreenState extends State<PlaylistScreen> {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
        valueListenable: Hive.box<zemaModel>('playlistDb').listenable(),
        builder:
            (BuildContext context, Box<zemaModel> musicList, Widget? child) {
          return Scaffold(
                        ...
                        child: SizedBox(
                            ...
                            child: ListView.builder(
                              itemBuilder: ((context, index) {
                                ...
                                return ValueListenableBuilder(
                                  valueListenable:
                                      Hive.box<zemaModel>('playlistDb')
                                          .listenable(),
                                  builder: (BuildContext context,
                                      Box<zemaModel> musicList, Widget? child) {
                                    return Hive.box<zemaModel>('playlistDb')
                                            .isEmpty
                                        ? Center(
                                            child: Container(
                                            height: 100,
  ...
  Future<dynamic> editPlaylistName(
      BuildContext context, zemaModel data, int index) {
    return showDialog(
      context: context,
                ...
                onPressed: () {
                  if (_formKey.currentState!.validate()) {
                    ...
                    if (name.isEmpty) {
                      ...
                      final playlistName = zemaModel(name: name, songId: []);
  ...
  Future<dynamic> deletePlaylist(
      BuildContext context, Box<zemaModel> musicList, int index) {
    return showDialog(
      context: context,
      builder: (context) {
        return AlertDialog(
...
Future<void> saveButtonPressed(context) async {
  final name = nameController.text.trim();
  final music = zemaModel(name: name, songId: []);
