...
import 'package:zema/view/HomeScreen/favorite/fav_button_player.dart';
          ...
          return AlertDialog(
            ...
            content: SizedBox(
              ...
              child: ValueListenableBuilder(
                  ...
                  builder: (BuildContext context, Box<zemaModel> musicList,
                      Widget? child) {
                    return Hive.box<zemaModel>('playlistDb').isEmpty
                        ? const Center(
                            child: Positioned(
                              right: 30,
                              left: 30,
